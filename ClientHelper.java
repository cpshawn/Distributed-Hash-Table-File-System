...
//            if (command.matches("S[0-6]") || command.equals("separate") || command.equals("merge")) {
//                break; // Exit the loop if the format is correct
//            } else {
...
//                            }
//
//                            messageToBeSent =  command + ":" + command + ":" + key  + ":" + value;
//                            break;
//                        case "multiput":
//                            while (true) {
//                                System.out.println("[Waiting]Enter key (0-" + maxRange + "):");
...
//                                }
//                            }
//                            messageToBeSent =  (command + ":" + command + ":" + key  + ":" + value  + ":" + commandRepeatedTimes);
//                            break;
//                        case "get":
//                            while (true) {
//                                System.out.println("[Waiting]Enter key (0-" + maxRange + "):");
